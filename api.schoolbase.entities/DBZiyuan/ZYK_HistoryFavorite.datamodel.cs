...
namespace api.schoolbase.entities.DBZiyuan
{
    ...
    {
        public static @__api.schoolbase.entities.DBZiyuan.Entity.ZYK_HistoryFavorite_Columns ZYK_HistoryFavorite = new @__api.schoolbase.entities.DBZiyuan.Entity.ZYK_HistoryFavorite_Columns();
    }
    namespace @__api.schoolbase.entities.DBZiyuan.Entity
    {
        public class ZYK_HistoryFavorite_Columns : MyLib.DbAccess.SQL.IQueryTable
        {
            private const string ___TABLE_NAME = "ZYK_HistoryFavorite";
            private string ___aliasName;
            public ZYK_HistoryFavorite_Columns(string aliasName) : base("DBZiyuan") { this.___aliasName = aliasName; }
            public ZYK_HistoryFavorite_Columns() : base("DBZiyuan") { this.___aliasName = ___TABLE_NAME; }
        ...
        #region Table Columns
    		...
    		public override string ___GetAliasName() { return ___aliasName ?? ___TABLE_NAME; }
            		...
            		public @__api.schoolbase.entities.DBZiyuan.Entity.ZYK_HistoryFavorite_Columns @__Alias(string aliasName) { return new @__api.schoolbase.entities.DBZiyuan.Entity.ZYK_HistoryFavorite_Columns(aliasName); }
        }
    }
    [System.Serializable]
    public partial class ZYK_HistoryFavorite
    {
        #region Property
