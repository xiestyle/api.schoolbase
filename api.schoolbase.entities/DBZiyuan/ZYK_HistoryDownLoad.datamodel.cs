...
namespace api.schoolbase.entities.DBZiyuan
{
    ...
    {
        public static @__api.schoolbase.entities.DBZiyuan.Entity.ZYK_HistoryDownLoad_Columns ZYK_HistoryDownLoad = new @__api.schoolbase.entities.DBZiyuan.Entity.ZYK_HistoryDownLoad_Columns();
    }
    namespace @__api.schoolbase.entities.DBZiyuan.Entity
    {
        public class ZYK_HistoryDownLoad_Columns : MyLib.DbAccess.SQL.IQueryTable
        {
            private const string ___TABLE_NAME = "ZYK_HistoryDownLoad";
            private string ___aliasName;
            public ZYK_HistoryDownLoad_Columns(string aliasName) : base("DBZiyuan") { this.___aliasName = aliasName; }
            public ZYK_HistoryDownLoad_Columns() : base("DBZiyuan") { this.___aliasName = ___TABLE_NAME; }
        ...
        #region Table Columns
    		...
    		public override string ___GetAliasName() { return ___aliasName ?? ___TABLE_NAME; }
            		...
            		public @__api.schoolbase.entities.DBZiyuan.Entity.ZYK_HistoryDownLoad_Columns @__Alias(string aliasName) { return new @__api.schoolbase.entities.DBZiyuan.Entity.ZYK_HistoryDownLoad_Columns(aliasName); }
        }
    }
    [System.Serializable]
    public partial class ZYK_HistoryDownLoad
    {
        #region Property
