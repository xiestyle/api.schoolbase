...
namespace api.schoolbase.entities.DBZiyuan
{
    ...
    {
        public static @__api.schoolbase.entities.DBZiyuan.Entity.ZYK_HistoryPinJia_Columns ZYK_HistoryPinJia = new @__api.schoolbase.entities.DBZiyuan.Entity.ZYK_HistoryPinJia_Columns();
    }
    namespace @__api.schoolbase.entities.DBZiyuan.Entity
    {
        public class ZYK_HistoryPinJia_Columns : MyLib.DbAccess.SQL.IQueryTable
        {
            private const string ___TABLE_NAME = "ZYK_HistoryPinJia";
            private string ___aliasName;
            public ZYK_HistoryPinJia_Columns(string aliasName) : base("DBZiyuan") { this.___aliasName = aliasName; }
            public ZYK_HistoryPinJia_Columns() : base("DBZiyuan") { this.___aliasName = ___TABLE_NAME; }
    
        #region Table Columns
    
    		private static MyLib.DbAccess.SQL.QueryColumn _SERID = new MyLib.DbAccess.SQL.QueryColumn((___TABLE_NAME + ".SERID"), DbType.Int32);
            public MyLib.DbAccess.SQL.QueryColumn SERID
            {
                get
                {
                    if ((this.___aliasName == ___TABLE_NAME)) return _SERID;
                    else return new MyLib.DbAccess.SQL.QueryColumn((this.___aliasName + ".SERID"), DbType.Int32);
                }
            }
    		...
    		private static MyLib.DbAccess.SQL.QueryColumn _Content = new MyLib.DbAccess.SQL.QueryColumn((___TABLE_NAME + ".Content"), DbType.String);
            public MyLib.DbAccess.SQL.QueryColumn Content
            {
                get
                {
                    if ((this.___aliasName == ___TABLE_NAME)) return _Content;
                    else return new MyLib.DbAccess.SQL.QueryColumn((this.___aliasName + ".Content"), DbType.String);
                }
            }
    		...
    		public override string ___GetAliasName() { return ___aliasName ?? ___TABLE_NAME; }
            		...
            		public @__api.schoolbase.entities.DBZiyuan.Entity.ZYK_HistoryPinJia_Columns @__Alias(string aliasName) { return new @__api.schoolbase.entities.DBZiyuan.Entity.ZYK_HistoryPinJia_Columns(aliasName); }
        }
    }
    [System.Serializable]
    public partial class ZYK_HistoryPinJia
    {
        #region Property
