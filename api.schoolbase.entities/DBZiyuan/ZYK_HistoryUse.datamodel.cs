...
namespace api.schoolbase.entities.DBZiyuan
{
    ...
    {
        public static @__api.schoolbase.entities.DBZiyuan.Entity.ZYK_HistoryUse_Columns ZYK_HistoryUse = new @__api.schoolbase.entities.DBZiyuan.Entity.ZYK_HistoryUse_Columns();
    }
    namespace @__api.schoolbase.entities.DBZiyuan.Entity
    {
        public class ZYK_HistoryUse_Columns : MyLib.DbAccess.SQL.IQueryTable
        {
            private const string ___TABLE_NAME = "ZYK_HistoryUse";
            private string ___aliasName;
            public ZYK_HistoryUse_Columns(string aliasName) : base("DBZiyuan") { this.___aliasName = aliasName; }
            public ZYK_HistoryUse_Columns() : base("DBZiyuan") { this.___aliasName = ___TABLE_NAME; }
        ...
        #region Table Columns
    		...
    		public override string ___GetAliasName() { return ___aliasName ?? ___TABLE_NAME; }
            		...
            		public @__api.schoolbase.entities.DBZiyuan.Entity.ZYK_HistoryUse_Columns @__Alias(string aliasName) { return new @__api.schoolbase.entities.DBZiyuan.Entity.ZYK_HistoryUse_Columns(aliasName); }
        }
    }
    [System.Serializable]
    public partial class ZYK_HistoryUse
    {
        #region Property
