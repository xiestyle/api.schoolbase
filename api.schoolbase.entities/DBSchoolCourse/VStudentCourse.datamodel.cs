...
namespace api.schoolbase.entities.DBSchoolCourse
{
    ...
    {
        public static @__api.schoolbase.entities.DBSchoolCourse.Entity.VStudentCourse_Columns VStudentCourse = new @__api.schoolbase.entities.DBSchoolCourse.Entity.VStudentCourse_Columns();
    }
    namespace @__api.schoolbase.entities.DBSchoolCourse.Entity
    {
        public class VStudentCourse_Columns : MyLib.DbAccess.SQL.IQueryTable
        {
            private const string ___TABLE_NAME = "VStudentCourse";
            private string ___aliasName;
            public VStudentCourse_Columns(string aliasName) : base("DBSchoolCourse") { this.___aliasName = aliasName; }
            public VStudentCourse_Columns() : base("DBSchoolCourse") { this.___aliasName = ___TABLE_NAME; }
        ...
        #region Table Columns
    		...
    		public override string ___GetAliasName() { return ___aliasName ?? ___TABLE_NAME; }
            		...
            		public @__api.schoolbase.entities.DBSchoolCourse.Entity.VStudentCourse_Columns @__Alias(string aliasName) { return new @__api.schoolbase.entities.DBSchoolCourse.Entity.VStudentCourse_Columns(aliasName); }
        }
    }
    [System.Serializable]
