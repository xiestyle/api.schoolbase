...
namespace api.schoolbase.entities.DBSchool
{
    ...
    {
        public static @__api.schoolbase.entities.DBSchool.Entity.VGrade_Columns VGrade = new @__api.schoolbase.entities.DBSchool.Entity.VGrade_Columns();
    }
    namespace @__api.schoolbase.entities.DBSchool.Entity
    {
        public class VGrade_Columns : MyLib.DbAccess.SQL.IQueryTable
        {
            private const string ___TABLE_NAME = "VGrade";
            private string ___aliasName;
            public VGrade_Columns(string aliasName) : base("DBSchool") { this.___aliasName = aliasName; }
            public VGrade_Columns() : base("DBSchool") { this.___aliasName = ___TABLE_NAME; }
        ...
        #region Table Columns
    		...
    		public override string ___GetAliasName() { return ___aliasName ?? ___TABLE_NAME; }
            		...
            		public @__api.schoolbase.entities.DBSchool.Entity.VGrade_Columns @__Alias(string aliasName) { return new @__api.schoolbase.entities.DBSchool.Entity.VGrade_Columns(aliasName); }
        }
    }
    [System.Serializable]
