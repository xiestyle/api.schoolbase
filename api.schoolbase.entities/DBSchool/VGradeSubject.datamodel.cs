...
namespace api.schoolbase.entities.DBSchool
{
    ...
    {
        public static @__api.schoolbase.entities.DBSchool.Entity.VGradeSubject_Columns VGradeSubject = new @__api.schoolbase.entities.DBSchool.Entity.VGradeSubject_Columns();
    }
    namespace @__api.schoolbase.entities.DBSchool.Entity
    {
        public class VGradeSubject_Columns : MyLib.DbAccess.SQL.IQueryTable
        {
            private const string ___TABLE_NAME = "VGradeSubject";
            private string ___aliasName;
            public VGradeSubject_Columns(string aliasName) : base("DBSchool") { this.___aliasName = aliasName; }
            public VGradeSubject_Columns() : base("DBSchool") { this.___aliasName = ___TABLE_NAME; }
        ...
        #region Table Columns
    		...
    		public override string ___GetAliasName() { return ___aliasName ?? ___TABLE_NAME; }
            		...
            		public @__api.schoolbase.entities.DBSchool.Entity.VGradeSubject_Columns @__Alias(string aliasName) { return new @__api.schoolbase.entities.DBSchool.Entity.VGradeSubject_Columns(aliasName); }
        }
    }
    [System.Serializable]
    public partial class VGradeSubject
    {
        #region Property
