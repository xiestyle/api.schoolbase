...
namespace api.schoolbase.entities.DBSchool
{
    ...
    {
        public static @__api.schoolbase.entities.DBSchool.Entity.VGroup4Grade_Columns VGroup4Grade = new @__api.schoolbase.entities.DBSchool.Entity.VGroup4Grade_Columns();
    }
    namespace @__api.schoolbase.entities.DBSchool.Entity
    {
        public class VGroup4Grade_Columns : MyLib.DbAccess.SQL.IQueryTable
        {
            private const string ___TABLE_NAME = "VGroup4Grade";
            private string ___aliasName;
            public VGroup4Grade_Columns(string aliasName) : base("DBSchool") { this.___aliasName = aliasName; }
            public VGroup4Grade_Columns() : base("DBSchool") { this.___aliasName = ___TABLE_NAME; }
        ...
        #region Table Columns
    		...
    		public override string ___GetAliasName() { return ___aliasName ?? ___TABLE_NAME; }
            		...
            		public @__api.schoolbase.entities.DBSchool.Entity.VGroup4Grade_Columns @__Alias(string aliasName) { return new @__api.schoolbase.entities.DBSchool.Entity.VGroup4Grade_Columns(aliasName); }
        }
    }
    [System.Serializable]
    public partial class VGroup4Grade
    {
        #region Property
