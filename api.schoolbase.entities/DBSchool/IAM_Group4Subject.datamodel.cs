...
namespace api.schoolbase.entities.DBSchool
{
    ...
    {
        public static @__api.schoolbase.entities.DBSchool.Entity.IAM_Group4Subject_Columns IAM_Group4Subject = new @__api.schoolbase.entities.DBSchool.Entity.IAM_Group4Subject_Columns();
    }
    namespace @__api.schoolbase.entities.DBSchool.Entity
    {
        public class IAM_Group4Subject_Columns : MyLib.DbAccess.SQL.IQueryTable
        {
            private const string ___TABLE_NAME = "IAM_Group4Subject";
            private string ___aliasName;
            public IAM_Group4Subject_Columns(string aliasName) : base("DBSchool") { this.___aliasName = aliasName; }
            public IAM_Group4Subject_Columns() : base("DBSchool") { this.___aliasName = ___TABLE_NAME; }
        ...
        #region Table Columns
    		...
    		public override string ___GetAliasName() { return ___aliasName ?? ___TABLE_NAME; }
            		...
            		public @__api.schoolbase.entities.DBSchool.Entity.IAM_Group4Subject_Columns @__Alias(string aliasName) { return new @__api.schoolbase.entities.DBSchool.Entity.IAM_Group4Subject_Columns(aliasName); }
        }
    }
    [System.Serializable]
    public partial class IAM_Group4Subject
    {
        #region Property
