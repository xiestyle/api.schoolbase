...
namespace api.schoolbase.entities.DBSchool
{
    ...
    {
        public static @__api.schoolbase.entities.DBSchool.Entity.VClassOfCurrentTerm_Columns VClassOfCurrentTerm = new @__api.schoolbase.entities.DBSchool.Entity.VClassOfCurrentTerm_Columns();
    }
    namespace @__api.schoolbase.entities.DBSchool.Entity
    {
        public class VClassOfCurrentTerm_Columns : MyLib.DbAccess.SQL.IQueryTable
        {
            private const string ___TABLE_NAME = "VClassOfCurrentTerm";
            private string ___aliasName;
            public VClassOfCurrentTerm_Columns(string aliasName) : base("DBSchool") { this.___aliasName = aliasName; }
            public VClassOfCurrentTerm_Columns() : base("DBSchool") { this.___aliasName = ___TABLE_NAME; }
        ...
        #region Table Columns
    		...
    		public override string ___GetAliasName() { return ___aliasName ?? ___TABLE_NAME; }
            		...
            		public @__api.schoolbase.entities.DBSchool.Entity.VClassOfCurrentTerm_Columns @__Alias(string aliasName) { return new @__api.schoolbase.entities.DBSchool.Entity.VClassOfCurrentTerm_Columns(aliasName); }
        }
    }
    [System.Serializable]
    public partial class VClassOfCurrentTerm
    {
        #region Property
