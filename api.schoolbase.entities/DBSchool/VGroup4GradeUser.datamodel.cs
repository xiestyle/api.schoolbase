...
namespace api.schoolbase.entities.DBSchool
{
    ...
    {
        public static @__api.schoolbase.entities.DBSchool.Entity.VGroup4GradeUser_Columns VGroup4GradeUser = new @__api.schoolbase.entities.DBSchool.Entity.VGroup4GradeUser_Columns();
    }
    namespace @__api.schoolbase.entities.DBSchool.Entity
    {
        public class VGroup4GradeUser_Columns : MyLib.DbAccess.SQL.IQueryTable
        {
            private const string ___TABLE_NAME = "VGroup4GradeUser";
            private string ___aliasName;
            public VGroup4GradeUser_Columns(string aliasName) : base("DBSchool") { this.___aliasName = aliasName; }
            public VGroup4GradeUser_Columns() : base("DBSchool") { this.___aliasName = ___TABLE_NAME; }
        ...
        #region Table Columns
    		...
    		public override string ___GetAliasName() { return ___aliasName ?? ___TABLE_NAME; }
            		...
            		public @__api.schoolbase.entities.DBSchool.Entity.VGroup4GradeUser_Columns @__Alias(string aliasName) { return new @__api.schoolbase.entities.DBSchool.Entity.VGroup4GradeUser_Columns(aliasName); }
        }
    }
    [System.Serializable]
    public partial class VGroup4GradeUser
    {
        #region Property
