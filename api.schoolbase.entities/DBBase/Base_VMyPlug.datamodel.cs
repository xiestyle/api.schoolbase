...
namespace api.schoolbase.entities.DBBase
{
    ...
    {
        public static @__api.schoolbase.entities.DBBase.Entity.Base_VMyPlug_Columns Base_VMyPlug = new @__api.schoolbase.entities.DBBase.Entity.Base_VMyPlug_Columns();
    }
    namespace @__api.schoolbase.entities.DBBase.Entity
    {
        public class Base_VMyPlug_Columns : MyLib.DbAccess.SQL.IQueryTable
        {
            private const string ___TABLE_NAME = "Base_VMyPlug";
            private string ___aliasName;
            public Base_VMyPlug_Columns(string aliasName) : base("DBBase") { this.___aliasName = aliasName; }
            public Base_VMyPlug_Columns() : base("DBBase") { this.___aliasName = ___TABLE_NAME; }
        ...
        #region Table Columns
    		...
    		public override string ___GetAliasName() { return ___aliasName ?? ___TABLE_NAME; }
            		...
            		public @__api.schoolbase.entities.DBBase.Entity.Base_VMyPlug_Columns @__Alias(string aliasName) { return new @__api.schoolbase.entities.DBBase.Entity.Base_VMyPlug_Columns(aliasName); }
        }
    }
    [System.Serializable]
    public partial class Base_VMyPlug
    {
        #region Property
