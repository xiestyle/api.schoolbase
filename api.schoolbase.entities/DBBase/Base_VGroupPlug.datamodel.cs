...
namespace api.schoolbase.entities.DBBase
{
    ...
    {
        public static @__api.schoolbase.entities.DBBase.Entity.Base_VGroupPlug_Columns Base_VGroupPlug = new @__api.schoolbase.entities.DBBase.Entity.Base_VGroupPlug_Columns();
    }
    namespace @__api.schoolbase.entities.DBBase.Entity
    {
        public class Base_VGroupPlug_Columns : MyLib.DbAccess.SQL.IQueryTable
        {
            private const string ___TABLE_NAME = "Base_VGroupPlug";
            private string ___aliasName;
            public Base_VGroupPlug_Columns(string aliasName) : base("DBBase") { this.___aliasName = aliasName; }
            public Base_VGroupPlug_Columns() : base("DBBase") { this.___aliasName = ___TABLE_NAME; }
        ...
        #region Table Columns
    		...
    		private static MyLib.DbAccess.SQL.QueryColumn _GroupUserType = new MyLib.DbAccess.SQL.QueryColumn((___TABLE_NAME + ".GroupUserType"), DbType.Int64);
            public MyLib.DbAccess.SQL.QueryColumn GroupUserType
            {
                get
                {
                    if ((this.___aliasName == ___TABLE_NAME)) return _GroupUserType;
                    else return new MyLib.DbAccess.SQL.QueryColumn((this.___aliasName + ".GroupUserType"), DbType.Int64);
                }
            }
    		...
    		public override string ___GetAliasName() { return ___aliasName ?? ___TABLE_NAME; }
            		...
            		public @__api.schoolbase.entities.DBBase.Entity.Base_VGroupPlug_Columns @__Alias(string aliasName) { return new @__api.schoolbase.entities.DBBase.Entity.Base_VGroupPlug_Columns(aliasName); }
        }
    }
    [System.Serializable]
    public partial class Base_VGroupPlug
    {
        #region Property
        ...
        public virtual long GroupUserType
        {
            get;
            set;
        }
